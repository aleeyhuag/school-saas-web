...
export default function MyClassPage() {
  ...
  const photoMutation = useMutation({ mutationFn: ({ id, file }) => myClassApi.uploadMyClassStudentPhoto(id, file), onSuccess: () => { qc.invalidateQueries({ queryKey: ['my-class-students'] }); setPhotoStudent(null); }, onError: (err) => setError(err.response?.data?.message ?? 'Could not upload student photo.') });
