...
export default function Landing() {
  ...
  return <div className="min-h-screen bg-bg">
    ...
    <main>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 pb-8"><div className="bg-surface border border-border rounded-2xl p-6 text-center"><h2 className="font-display font-bold text-xl text-ink">Want to help schools discover Skulag?</h2><p className="text-sm text-muted mt-2">Join our referral programme and earn commission on schools you introduce.</p><Link to="/referrals" className="inline-flex mt-4 bg-primary text-white font-semibold px-5 py-3 rounded-xl">Become a referral partner</Link></div></section><section className="max-w-6xl mx-auto px-4 md:px-8 pb-16"><div className="bg-accent-soft border border-accent/20 rounded-3xl p-7 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6"><div><p className="text-xs font-bold text-warning uppercase tracking-widest mb-2">Built to scale with your school</p><h2 className="text-2xl md:text-3xl font-display font-extrabold text-ink">Stop moving school operations between notebooks, spreadsheets and chats.</h2><p className="text-sm text-muted mt-2 max-w-2xl">Give every role a clear place to work and keep the school's records connected.</p></div><Link to="/register-school" className="shrink-0 bg-primary text-white font-semibold px-6 py-3 rounded-xl hover:bg-primary-hover">Get started</Link></div></section>
