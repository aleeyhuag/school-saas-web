          ...
          <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-12 items-center">
            ...
            <div className="bg-surface border border-border rounded-3xl shadow-xl p-3 md:p-4 rotate-0 lg:rotate-1">
              <div className="border border-border rounded-2xl overflow-hidden">
                <div className="h-12 border-b border-border flex items-center px-4 gap-2"><div className="w-7 h-7 rounded-lg bg-primary text-white flex items-center justify-center font-display font-bold text-xs">{BRAND.productName[0]}</div><span className="text-sm font-display font-bold text-ink">School dashboard</span><span className="ml-auto w-2 h-2 rounded-full bg-success" /></div>
